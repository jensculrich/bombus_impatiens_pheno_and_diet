...
model {
  ...
  beta_julian ~ normal(mu_beta_julian, sigma_beta_julian); // weakly informative prior for effect of date
  mu_beta_julian ~ normal(0, 2);
  sigma_beta_julian ~ normal(0, 2);
  beta_julian_sq ~ normal(mu_beta_julian_sq, sigma_beta_julian_sq); // weakly informative prior for effect ofdate squared
